...
const LoginForm = () => {
    ...
    const handleSubmit = (e) => {
      ...
      if (emailValue === VALID_EMAIL && passwordValue === VALID_PASSWORD) {
        setMessage({
          text: `Busetdah! Login berhasil!! Selamat datang, ${emailValue}`,
          type: 'success',
        })
      } else {
        setMessage({ text: 'Idih Email atau password salah.', type: 'error' })
      }
    }
